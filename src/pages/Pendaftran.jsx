...
import { FaUser, FaVenusMars, FaMapMarkerAlt, FaPhone, FaSchool, FaBook, FaBirthdayCake, FaIdCard } from 'react-icons/fa';
...
const Pendaftaran = () => {
  ...
  const validate = () => {
    ...
    else if (alamat.length < 7) newErrors.alamat = "Alamat minimal 7 karakter";
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        Swal.fire({
          title: "Gagal!",
          text: "Terjadi kesalahan saat mendaftarkan data.",
          icon: "error",
          confirmButtonText: "OK",
          background: darkMode ? '#2c3e50' : 'white',
          color: darkMode ? 'white' : '#2c3e50'
